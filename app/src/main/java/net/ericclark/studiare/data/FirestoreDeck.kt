...
data class FirestoreDeck(
    ...
    val normalizationType: String = "None",
    val sortType: String = "None",
    ...
    fun toAppDeck(): Deck {
        return Deck(
            ...
            normalizationType = this.normalizationType.toNormalizationType(),
            deckSortMode = this.sortType.toDeckSortMode(),
...
fun Deck.toFirestoreDeck(): FirestoreDeck {
    return FirestoreDeck(
        ...
        updatedAt = this.updatedAt,
        averageQuizScore = this.averageQuizScore,
        normalizationType = this.normalizationType.toString(),
        sortType = this.deckSortMode.toString(),
        isStarred = this.isStarred,
        cardIds = this.cardIds,
        frontLanguage = this.frontLanguage,
        backLanguage = this.backLanguage,
